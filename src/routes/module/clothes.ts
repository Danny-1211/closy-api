...
clothesRouter.post('/', authMiddleWare, async (req, res) => {
           ...
           "application/json": {
             schema: {
               ...
               properties: {
                 ...
                 occasions: { type: "array", items: { type: "string" }, example: ["上班", "約會"] },
                 seasons: { type: "array", items: { type: "string" }, example: ["春", "秋"] },
    ...
    */
    ...
    if (!category || !cloudImgUrl || !name || !color || !occasions || !seasons || !brand) {
